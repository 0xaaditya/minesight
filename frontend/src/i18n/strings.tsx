...
const STRINGS = {
  en: {
    ...
    refuelEvents: 'Refuelling events',
    refuelPlaceholder: 'Vehicles refuelled by this bowser will appear here once fuel-level sensing is wired — a nearby vehicle whose fuel rises while parked beside the bowser gets attributed to it.',
  ...
  hi: {
    ...
    refuelEvents: 'ईंधन भरने की घटनाएँ',
    refuelPlaceholder: 'ईंधन-स्तर सेंसिंग जुड़ने के बाद इस बाउज़र से भरे गए वाहन यहाँ दिखेंगे — बाउज़र के पास खड़े वाहन का ईंधन बढ़ने पर वह इसी को दर्ज होगा।',
  ...
  mr: {
    ...
    refuelEvents: 'इंधन भरण्याच्या नोंदी',
    refuelPlaceholder: 'इंधन-पातळी सेन्सिंग जोडल्यावर या बाउझरने भरलेली वाहने येथे दिसतील — बाउझरजवळ उभ्या वाहनाचे इंधन वाढल्यास ते याला नोंदवले जाईल.',
